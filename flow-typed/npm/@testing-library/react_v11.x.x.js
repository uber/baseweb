...
declare module '@testing-library/react' {
  ...
  declare export function queryAllByTestId(
    container: HTMLElement,
    id: Matcher,
    options?: MatcherOptions,
  ): Array<HTMLElement>;
  ...
  declare export function queryAllByText(
    container: HTMLElement,
    text: Matcher,
    options?: MatcherOptions,
  ): Array<HTMLElement>;
  ...
  declare export function findByText(
    container: HTMLElement,
    text: Matcher,
    options?: {selector?: string, ...} & MatcherOptions,
  ): HTMLElement;
  ...
  declare export function queryByRole(
    container: HTMLElement,
    role: ByRoleMatcher,
    options?: ByRoleOptions,
  ): ?HTMLElement;
  ...
  declare export function getByRole(
    container: HTMLElement,
    role: ByRoleMatcher,
    options?: ByRoleOptions,
  ): HTMLElement;
  declare export function getAllByRole(
    container: HTMLElement,
    role: ByRoleMatcher,
    options?: ByRoleOptions,
  ): Array<HTMLElement>;
