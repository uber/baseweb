// flow-typed signature: 6324ab03faa3971f5d6ea8e57257a88a
// flow-typed version: <<STUB>>/@babel/plugin-proposal-decorators_v^7.0.0/flow_v0.98.0
...
declare module '@babel/plugin-proposal-decorators/lib/index.js' {
  declare module.exports: $Exports<
    '@babel/plugin-proposal-decorators/lib/index',
  >;
}
declare module '@babel/plugin-proposal-decorators/lib/transformer-legacy.js' {
  declare module.exports: $Exports<
    '@babel/plugin-proposal-decorators/lib/transformer-legacy',
  >;
}
declare module '@babel/plugin-proposal-decorators/lib/transformer.js' {
  declare module.exports: $Exports<
    '@babel/plugin-proposal-decorators/lib/transformer',
  >;
}
