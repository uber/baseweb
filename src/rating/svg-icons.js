...
export function angryRatingSVG(fillColor: string, size: string) {
  return encodeURIComponent(`
...
export function sadRatingSVG(fillColor: string, size: string) {
  return encodeURIComponent(`
    <svg width="${size}" height="${size}" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="22" cy="22" r="20" fill="${fillColor}"/>
...
export function neutralRatingSVG(fillColor: string, size: string) {
  return encodeURIComponent(`
    <svg width="${size}" height="${size}" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="22" cy="22" r="20" fill="${fillColor}"/>
...
export function happyRatingSVG(fillColor: string, size: string) {
  return encodeURIComponent(`
    <svg width="${size}" height="${size}" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="22" cy="22" r="20" fill="${fillColor}"/>
      <ellipse cx="16" cy="18" rx="2" ry="2" fill="black"/>
...
export function veryHappyRatingSVG(fillColor: string, size: string) {
  return encodeURIComponent(`
    <svg width="${size}" height="${size}" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="22" cy="22" r="20" fill="${fillColor}"/>
      <ellipse cx="16" cy="18" rx="2" ry="2" fill="black"/>
