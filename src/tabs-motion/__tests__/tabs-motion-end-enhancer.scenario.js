...
export function Scenario() {
  ...
  const [activeKey5, setActiveKey5] = React.useState(0);
  const [activeKey2, setActiveKey2] = React.useState(0);
  const [activeKey3, setActiveKey3] = React.useState(0);
  const [activeKey4, setActiveKey4] = React.useState(0);
  return (
    <>
