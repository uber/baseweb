...
describe('tabs', () => {
  ...
  describe('ltr', () => {
    it('ltr *direction* moves focus to next tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion');
      const tabs = await getTabs();
      await tabs[0].focus();
      expect(await isActiveEl(tabs[0])).toBeTruthy();
    ...
    it('ltr *direction* moves focus to previous tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion');
      const tabs = await getTabs();
      await tabs[1].focus();
      expect(await isActiveEl(tabs[1])).toBeTruthy();
    ...
    it('ltr *direction* moves focus to first tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion');
      const tabs = await getTabs();
      await tabs[2].focus();
      expect(await isActiveEl(tabs[2])).toBeTruthy();
    ...
    it('ltr *direction* moves focus to last tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion');
      const tabs = await getTabs();
      await tabs[0].focus();
      expect(await isActiveEl(tabs[0])).toBeTruthy();
  ...
  describe('rtl', () => {
    it('rtl *direction* moves focus to next tab', async () => {
    ...
    it('rtl *direction* moves focus to previous tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion', 'light', true);
      const tabs = await getTabs();
      await tabs[1].focus();
      expect(await isActiveEl(tabs[1])).toBeTruthy();
    ...
    it('rtl *direction* moves focus to first tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion', 'light', true);
      const tabs = await getTabs();
      await tabs[2].focus();
      expect(await isActiveEl(tabs[2])).toBeTruthy();
    ...
    it('rtl *direction* moves focus to last tab', async () => {
      await mount(page, 'tabs-motion--tabs-motion', 'light', true);
      const tabs = await getTabs();
      await tabs[0].focus();
      expect(await isActiveEl(tabs[0])).toBeTruthy();
  ...
  describe('vertical', () => {
    it('vertical *direction* moves focus to next tab', async () => {
    ...
    it('vertical *direction* moves focus to previous tab', async () => {
      await mount(page, 'tabs-motion--vertical');
      const tabs = await getTabs();
      await tabs[1].focus();
      expect(await isActiveEl(tabs[1])).toBeTruthy();
    ...
    it('vertical *direction* moves focus to first tab', async () => {
      await mount(page, 'tabs-motion--vertical');
      const tabs = await getTabs();
      await tabs[2].focus();
      expect(await isActiveEl(tabs[2])).toBeTruthy();
    ...
    it('vertical *direction* moves focus to last tab', async () => {
      await mount(page, 'tabs-motion--vertical');
      const tabs = await getTabs();
      await tabs[0].focus();
      expect(await isActiveEl(tabs[0])).toBeTruthy();
