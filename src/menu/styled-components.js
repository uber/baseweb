...
export const StyledList = styled<StyledPropsT>('ul', ({$theme}) => {
  return {
    ...
    paddingLeft: 0,
    paddingRight: 0,
    borderTopLeftRadius: $theme.borders.menuBorderRadius,
    borderTopRightRadius: $theme.borders.menuBorderRadius,
    borderBottomRightRadius: $theme.borders.menuBorderRadius,
    borderBottomLeftRadius: $theme.borders.menuBorderRadius,
