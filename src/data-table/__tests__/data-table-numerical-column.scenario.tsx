...
export function Scenario() {
  return (
    ...
    >
      ...
      <div id="accounting">
        <AccountingFilter close={() => {}} setFilter={() => {}} data={accountingData} />
      </div>
      <div id="percentage">
        <PercentageFilter close={() => {}} setFilter={() => {}} data={probabilityData} />
      </div>
      <div id="small">
      ...
      <div id="ts">
        <HighPrecisionFilter close={() => {}} setFilter={() => {}} data={precisionData} />
      </div>
    </div>
  );
}
