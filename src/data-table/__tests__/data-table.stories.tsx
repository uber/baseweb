...
import { Scenario as DataTableImperativeClearSelection } from './data-table-imperative-clear-selection.scenario';
...
export const ImperativeClearSelection = () => <DataTableImperativeClearSelection />;
