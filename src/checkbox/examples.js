...
export default {
  ...
  [examples.COMPONENTS_OVERRIDES]: () => {
    const customLabel = () => {
      ...
      return (
        <span>
          This is a totally different <b>checkbox</b>. Click on hourglass
