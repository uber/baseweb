...
export default function FlagCV(props: {width: string}) {
  return (
    <svg viewBox="0 0 21 15" width={props.width}>
      <defs>
        <linearGradient id="CVa" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFF" />
          <stop offset="100%" stopColor="#F0F0F0" />
        </linearGradient>
        <linearGradient id="CVb" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#0C49AE" />
          <stop offset="100%" stopColor="#063B91" />
        </linearGradient>
        <linearGradient id="CVc" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#CD232E" />
          <stop offset="100%" stopColor="#CD232E" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#CVa)" d="M0 0h21v15H0z" />
        <path fill="url(#CVb)" d="M0 0h21v8H0zM0 11h21v4H0z" />
        <path fill="url(#CVa)" d="M0 8h21v3H0z" />
        <path fill="url(#CVc)" d="M0 9h21v1H0z" />
        <path
          fill="#F7D035"
          fillRule="nonzero"
