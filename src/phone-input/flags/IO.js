...
export default function FlagIO(props: {width: string}) {
  const {width, ...restProps} = props;
  return (
    <svg viewBox="0 0 21 15" width={width} {...restProps}>
      <defs>
        <linearGradient id="IOa" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFF" />
          <stop offset="100%" stopColor="#F0F0F0" />
        </linearGradient>
        <linearGradient id="IOb" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#07319C" />
          <stop offset="100%" stopColor="#00247E" />
        </linearGradient>
        <linearGradient id="IOc" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#DB1E36" />
          <stop offset="100%" stopColor="#D51931" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#IOa)" d="M0 0h21v15H0z" />
        <path
          fill="url(#IOb)"
        ...
        <path
          fill="url(#IOc)"
          d="M5.66 3.91l-3.5-3h.5l3.5 2.5h1l4-2.5v.25a.537.537 0 0 1-.208.399L7.66 3.91v1l3.312 2.839c.104.089.072.161-.062.161a.898.898 0 0 1-.458-.149L7.16 5.41h-1l-4 2.5v-.5l3.5-2.5v-1z"
          transform="translate(-2.16 -.91)"
        />
        <path
          fill="url(#IOa)"
          d="M2.16 3.41v2h3.5v2.505c0 .273.214.495.505.495h.99a.496.496 0 0 0 .505-.495V5.41h3.51a.49.49 0 0 0 .49-.505v-.99a.495.495 0 0 0-.49-.505H7.66V.91h-2v2.5h-3.5z"
          transform="translate(-2.16 -.91)"
        />
        <path
          fill="url(#IOc)"
