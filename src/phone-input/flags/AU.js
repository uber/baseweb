...
export default function FlagAU(props: {width: string}) {
  return (
    <svg viewBox="0 0 21 15" width={props.width}>
      <defs>
        <linearGradient id="AUa" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFF" />
          <stop offset="100%" stopColor="#F0F0F0" />
        </linearGradient>
        <linearGradient id="AUb" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#0A17A7" />
          <stop offset="100%" stopColor="#030E88" />
        </linearGradient>
        <linearGradient id="AUc" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#DB1E36" />
          <stop offset="100%" stopColor="#D51931" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#AUa)" d="M0 0h21v15H0z" />
        <path fill="url(#AUb)" d="M0 0h21v15H0z" />
        <path
          fill="url(#AUa)"
          fillRule="nonzero"
