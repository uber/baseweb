...
export default function FlagHM(props: {width: string}) {
  const {width, ...restProps} = props;
  return (
    <svg viewBox="0 0 21 15" width={width} {...restProps}>
      <defs>
        <linearGradient id="HMa" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFF" />
          <stop offset="100%" stopColor="#F0F0F0" />
        </linearGradient>
        <linearGradient id="HMb" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#0A17A7" />
          <stop offset="100%" stopColor="#030E88" />
        </linearGradient>
        <linearGradient id="HMc" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#DB1E36" />
          <stop offset="100%" stopColor="#D51931" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#HMa)" d="M0 0h21v15H0z" />
        <path fill="url(#HMb)" d="M0 0h21v15H0z" />
        <path
          fill="#FFF"
          d="M4.5 12.25l-.882.464.169-.982-.714-.696.986-.143L4.5 10l.44.893.987.143-.714.696.169.982z"
        />
        <path
          fill="url(#HMa)"
          fillRule="nonzero"
        ...
        />
        <path fill="url(#HMc)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
        <path
          fill="#FFF"
          d="M15 13l-.707.207.207-.707-.207-.707L15 12l.707-.207-.207.707.207.707zM15 3.5l-.707.207L14.5 3l-.207-.707L15 2.5l.707-.207L15.5 3l.207.707zM18 6.5l-.707.207L17.5 6l-.207-.707L18 5.5l.707-.207L18.5 6l.207.707zM12 7.5l-.707.207L11.5 7l-.207-.707L12 6.5l.707-.207L12.5 7l.207.707zM16.5 8.75l-.354.104.104-.354-.104-.354.354.104.354-.104-.104.354.104.354z"
        />
      </g>
    </svg>
  );
