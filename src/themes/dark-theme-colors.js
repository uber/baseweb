...
export default {
  colors: {
    ...
    buttonPrimaryHover: primitives.mono200,
    buttonPrimaryActive: primitives.mono300,
    buttonPrimaryDisabledFill: primitives.mono900,
    buttonSecondaryFill: primitives.mono700,
    ...
    buttonTertiaryActive: primitives.mono800,
    buttonTertiaryDisabledFill: 'transparent',
    // deprecated: to be removed
    buttonMinimalFill: 'transparent',
    buttonMinimalText: primitives.white,
    buttonMinimalHover: primitives.mono900,
    buttonMinimalActive: primitives.mono800,
    ...
    calendarForeground: primitives.mono200,
    calendarForegroundDisabled: primitives.mono800,
    calendarHeaderBackground: primitives.mono900,
    calendarHeaderForeground: primitives.mono200,
    calendarHeaderBackgroundActive: primitives.mono1000,
    calendarHeaderForegroundDisabled: primitives.mono800,
    calendarDayBackgroundPseudoSelected: primitives.mono800,
    calendarDayForegroundPseudoSelected: primitives.mono200,
    calendarDayBackgroundPseudoSelectedHighlighted: primitives.mono700,
    calendarDayForegroundPseudoSelectedHighlighted: primitives.mono200,
    calendarDayBackgroundSelected: primitives.mono200,
