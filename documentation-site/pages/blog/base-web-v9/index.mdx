...
<Table
  columns={['Name', 'Old', 'New']}
  data={[
    ['Label1', 'font350, 14px/20px/500', 'font450, 18px/28px/500'],
    ['Label2', 'font450, 16px/20px/500', 'font350, 16px/24px/500'],
    ['Label3', '-', 'font250, 14px/20px/500'],
    ['Label4', '-', 'font150, 12px/20px/500'],
    ['Paragraph1', 'font300, 14px/20px/400', 'font400, 18px/28px/400'],
    ['Paragraph2', 'font400, 16px/20px/400', 'font300, 16px/24px/400'],
    ['Paragraph3', '-', 'font200, 14px/20px/400'],
    ['Paragraph4', '-', 'font100, 12px/20px/400'],
  ]}
/>

In terms of migrating, you will want to change `Label1` and `Paragraph1` to `Label3` and `Paragraph3`.
