...
Version `8.17` brings some noticeable style updates to Base Web. Read below to find out what has changed and how you can safely incorporate these changes into your codebase.
...
Some folks may wonder why there is a noticeable stylistic update coming to Base Web. Others might ask why these changes are coming as a minor version and not a breaking major. After all, this version will likely require code changes in projects that use Base Web.
