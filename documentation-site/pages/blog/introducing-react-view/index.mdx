...
Our team is responsible for this website and the entire Base Web component library. Naturally, you might assume that most of our job consists of building React components. However, as the number of Base Web users grows, some days it feels more like this:
