...
React View is an **interactive playground**, **documentation** and **code generator** for your components. You can use it to document your React component APIs, let users live-edit props and grab the generated ready-to-use source code.
