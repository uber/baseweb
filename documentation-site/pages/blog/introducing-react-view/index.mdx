...
The example below demonstrates all basic features of React View:
...
**And that's a good thing**. If you don’t spend a lot of time helping other developers, it means that nobody uses your tools. We went from 0 to almost 500 applications at Uber in a single year! That translates into about 1000 of developers. There are 50 components, hundreds of props and endless possibilities. Is there a way to reduce the burden of support?

We believe that by building na amazing documentation we can significantly reduce the number of questions in our chats and make developers happier. We have invested a significant amount of time to experiment with different kinds of documentation and React View is our latest iteration.
...
**Bring your own UI**. The View component is a tiny wrapper around the `useView` hook. If you wish to customize and have more control, you can use the `useView` hook directly. You can still re-use our default UI components or create your own:
...
**It is a set of tools** that aspires to close the gap between users, developers and designers of component libraries. React View aims to make documentation more interactive and useful. It utilizes already popular tools as babel and prettier.
...
**We could all save a lot of time by not writing a code that can be generated**.
