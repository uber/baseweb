...
```js
// @flow
import {styled, createThemedStyled} from 'spaceweb';
...
```js
// @flow
import {styled, withStyle} from 'spaceweb';
...
```js
// @flow
import {createThemedStyled, createThemedWithStyle} from 'spaceweb';
...
```js
// @flow
import {createThemedUseStyletron} from 'spaceweb';
...
+import {createThemedStyled} from 'spaceweb';
