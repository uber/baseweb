...
may be some follow-up after running. You can run the codemod locally with the command below:

```shell
$ npx @uber-web-ui/baseui-codemods --mod=v8Types --dir=<path_to_code>
```

[Click here](https://www.npmjs.com/package/@uber-web-ui/baseui-codemods) for more information on `baseui` codemods.
