...
<BlogImage src={'/images/blog/getting-started-with-base-web/input-with-cta.png'} />
...
const setNewPassword = (p) => {
  const newPassword = p ? p : generatePassword({ length, numbers, uppercase, symbols });
...
<BlogImage src={'/images/blog/getting-started-with-base-web/strength-meter.gif'} />
