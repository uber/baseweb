  ...
  overrides={{
    InputContainer: {
      style: ({ $theme }) => ({
        ...
        borderRadiusTopLeft: $theme.sizing.scale200,
        borderRadiusTopRight: $theme.sizing.scale200,
        borderRadiusBottomRight: $theme.sizing.scale200,
        borderRadiusBottomLeft: $theme.sizing.scale200,
        borderStyle: 'solid',
