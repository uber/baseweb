...
The USP for Styletron is its novel approach to CSS in JS. Other libraries do things like inline styles or generate scoped classes.
...
You can think of Styletron as gaining the benefit of atomic CSS without the overhead. You write your styles, it does the utility class part for you!
