...
<Table columns={['Name', 'CSS Engine', 'Customization']} data={[
  ['Base UI', 'CSS-in-JS, using Styletron', 'Through an extensive overrides interface'],
  ['Material UI', 'CSS-in-JS, using JSS', 'Through CSS overrides'],
  ['Ant Design', 'Less', 'Through Less variables'],
  ['React Bootstrap', 'SCSS, inherited from Bootstrap', 'Through Bootstrap themes'],
