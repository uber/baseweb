...
Furthermore, if you have a page that loads dynamically, you will have to dynamically import `styletron-engine-atomic` on the `useEffect` hook of your app's entry point:
