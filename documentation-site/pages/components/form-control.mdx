...
<Yard placeholderHeight={136} {...formControlYardConfig} />
...
<ApiTable
  ...
  types={require('!!extract-react-types-loader!../../../src/form-control/form-control')}
/>

<Exports component={FormControlExports} title="Form Control exports" path="baseui/form-control" />
