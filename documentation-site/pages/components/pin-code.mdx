...
<Example title="Basic Usage" path="examples/pin-code/basic.js">
  <PinCodeBasic />
</Example>
...
<Example title="Changing the code length" path="examples/pin-code/length.js">
  <PinCodeLength />
</Example>
...
<Example title="Passing id and name" path="examples/pin-code/id-and-name.js">
  <PinCodeIdAndName />
</Example>

Similarly, you can pass an individual `id` or `name` prop to each input.
Just provide an array of strings to `ids` or `names` and each string will be passed through to the respective input.

These are the only props that will target individual inputs.
Every other prop that `PinCode` accepts is ‟shared” between the inputs.
Hopefully, you donʼt have many reasons to target the inputs individually.

<Example title="Various states" path="examples/pin-code/states.js">
  <PinCodeStates />
</Example>

`PinCode` accepts most of the same boolean props as our other inputs: `disabled`, `error`, `positive`, etc.

<Example title="Various sizes" path="examples/pin-code/sizes.js">
  <PinCodeSizes />
</Example>
...
<Example
  ...
  path="examples/pin-code/placeholder.js"
>
  <PinCodePlaceholder />
</Example>
...
<Example title="Disable focus management" path="examples/pin-code/no-tab.js">
  <PinCodeNoTab />
</Example>
...
<Example title="Autofocus" path="examples/pin-code/autofocus.js">
  <PinCodeAutofocus />
</Example>
...
<Example
  title="Once things are filled in"
  path="examples/pin-code/completion.js"
>
  <PinCodeCompletion />
</Example>
...
<Example
  title="Autocomplete and Copy + Paste"
  path="examples/pin-code/basic.js"
>
  <PinCodeBasic />
</Example>
...
<Example title="Overriding the Input" path="examples/pin-code/override.js">
  <PinCodeOverride />
</Example>
