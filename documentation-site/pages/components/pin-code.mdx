...
<Yard componentName="Pin Code" placeholderHeight={48} {...pinYardConfig} />
...
<API
  heading="PinCode API"
  api={require('!!extract-react-types-loader!../../../src/pin-code/pin-code.js')}
/>

<API
  heading="StatefulPinCode API"
  api={require('!!extract-react-types-loader!../../../src/pin-code/stateful-pin-code.js')}
/>
