...
import PhoneInputBasicWithFilter from 'examples/phone-input/basic-with-filter.js';
...
<Example
  title="Basic with enabled dropdown filter"
  path="phone-input/basic-with-filter.js"
>
  <PhoneInputBasicWithFilter />
</Example>
...
Click [here](/theming/understanding-overrides/#override-nested-components) to learn more about nested overrides.
...
<Overrides
  ...
  renderExample={props => <StatefulPhoneInput {...props} enableFiltering />}
  whitelisted={[
    'Input',
    'DialCode',
    'CountrySelect',
