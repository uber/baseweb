...
import PhoneInputNext from 'examples/phone-input/basic-next.js';
...
<Example title="Updated phone input design" path="phone-input/basic-next.js">
  <PhoneInputNext />
</Example>

Starting in version v11, `PhoneInputNext` will replace the current `PhoneInput`, where the country picker is split from the input element.
