...
<API
  ...
  api={require('!!extract-react-types-loader!../../../src/phone-input/stateful-phone-input.js')}
/>

<API
  heading="StatefulPhoneInputContainer API"
  api={require('!!extract-react-types-loader!../../../src/phone-input/stateful-phone-input-container.js')}
/>
