...
import PhoneInputAlternative from 'examples/phone-input/alternative.js';
...
<Example title="Alternative design" path="phone-input/alternative.js">
  <PhoneInputAlternative />
</Example>

Use `PhoneInputAlternative` for an alternative look where the country picker is split from the input element.
