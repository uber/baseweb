...
| -------------------------- | ------------------ | ------------------------------------------------------------- |
| `THRESHOLD.high` (default) | >80% drag distance | Standard — requires deliberate intent                         |
| `THRESHOLD.low`            | >20% drag distance | Users with motor disabilities, seniors, or low-friction flows |
