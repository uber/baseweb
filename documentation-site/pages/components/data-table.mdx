...
<Example title="Customized Column Sort" path="data-table/customized-column-sort.tsx">
  <CustomizedColumnSort />
</Example>

<Example title="Customized Empty State" path="data-table/customized-empty-state.tsx">
  <CustomizedEmptyState />
</Example>

<Example title="Imperatively access table data" path="data-table/access-table-data.tsx">
  <AccessTableData />
</Example>
