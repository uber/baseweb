...
import CustomizedColumnSort from 'examples/data-table/customized-column-sort.js';
import AccessTableData from 'examples/data-table/access-table-data.js';
...
<Example title="Customized Column Sort" path="data-table/customized-column-sort.js">
  <CustomizedColumnSort />
</Example>

<Example title="Customized Empty State" path="data-table/customized-empty-state.js">
  <CustomizedEmptyState />
</Example>

<Example title="Imperatively access table data" path="data-table/access-table-data.js">
  <AccessTableData />
</Example>
...
<Exports component={DataTableExports} title="Data-Table exports" path="baseui/data-table" />
