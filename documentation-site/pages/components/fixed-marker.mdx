...
<Example title="Start enhancer with label" path="fixed-marker/start-enhancer.tsx">
  <StartEnhancer />
</Example>
...
<Example title="End enhancer with custom color" path="fixed-marker/end-enhancer-color.tsx">
  <EndEnhancerColor />
</Example>

A fixed map marker with an end enhancer icon, a label, and custom styling.

<Example title="Large size with only an icon" path="fixed-marker/start-enhancer-large.tsx">
  <StartEnhancerLarge />
</Example>
...
<Example title="Draggable marker with react-map-gl" path="fixed-marker/react-map-gl-dragging.tsx">
  <ReactMapGLDragging />
</Example>
