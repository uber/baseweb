...
<Example title="Popover opens on Click" path="examples/popover/stateful-click.js">
  <StatefulClick />
</Example>

<Example title="Popover Opens on Hover" path="examples/popover/stateful-hover.js">
  <StatefulHover />
</Example>

<Example title="Popover Available Placements" path="examples/popover/placements.js">
  <Placements />
</Example>
