...
<API
  ...
  api={require('!!extract-react-types-loader!../../../src/aspect-ratio-box/aspect-ratio-box')}
/>

<API
  heading="AspectRatioBoxBody API"
  api={require('!!extract-react-types-loader!../../../src/aspect-ratio-box/aspect-ratio-box-body')}
/>
