...
`Tether` component provides a behavior where its content positined relatively to a provided anchor element. Popover component is a good example of the `Tether` component usage.
