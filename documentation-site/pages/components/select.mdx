...
<Example title="Select basic usage" path="select/basic.js">
  <SelectBasic />
</Example>
...
<Example title="Select controlled example" path="select/controlled.js">
  <SelectControlled />
</Example>
...
<Example title="Select with open dropdown" path="select/open.js">
  <SelectOpen />
</Example>
