...
<Example title="Select as single-pick search" path="select/search-single-pick.tsx">
...
<Example title="Select as multi-pick search" path="select/search-multi-pick.tsx">
...
<Example title="Imperatively control dropdown" path="select/control-ref-dropdown.tsx">
  <SelectDropdown />
</Example>

<Example title="Imperatively control input value" path="select/control-ref-input-value.tsx">
  <SelectInputValue />
</Example>
...
<Example title="Select dropdown overrides" path="select/overridden-dropdown.tsx">
...
<Exports component={SelectExports} title="Select exports" path="baseui/select" />
