...
import SelectDropdown from 'examples/select/control-ref-dropdown.js';
import SelectInputValue from 'examples/select/control-ref-input-value.js';
...
<Example title="Imperatively control input focus" path="select/focus.js">
  <SelectFocus />
</Example>

<Example title="Imperatively control dropdown" path="select/control-ref-dropdown.js">
  <SelectDropdown />
</Example>

<Example title="Imperatively control input value" path="select/control-ref-input-value.js">
  <SelectInputValue />
</Example>
...
<Example title="Select with async options" path="select/async-options.js">
  <SelectAsyncOptions />
</Example>
