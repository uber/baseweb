...
<Yard placeholderHeight={90} compilerStyles={{ marginTop: '56px' }} {...sliderYardConfig} />
...
<ApiTable
  ...
  types={require('!!extract-react-types-loader!../../../src/slider/slider')}
/>

<Exports component={SliderExports} title="Slider exports" path="baseui/slider" />
