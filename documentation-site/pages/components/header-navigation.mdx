...
<Example title="Header navigation basic usage" path="header-navigation/basic.tsx">
  <BasicHeader />
</Example>

<Example title="Header navigation with search" path="header-navigation/with-search.tsx">
  <WithSearch />
</Example>
