...
<Example title="Progress bar with Visible Label" path="examples/progress-bar/with-label.js">
  <WithLabel />
</Example>

<Example title="Progress bar with Custom Label" path="examples/progress-bar/custom-label.js">
  <CustomLabel />
</Example>
...
<Example title="Progress bar with Overrides" path="examples/progress-bar/overrides.js">
  <Customization />
</Example>
