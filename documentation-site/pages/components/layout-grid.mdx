...
Some examples may require you to open them in StackBlitz to achieve a wide enough viewport for certain behaviors.
...
To appreciate this example you may need to open it in StackBlitz. The "behavior" (😅) is only visible on a wider viewport.
