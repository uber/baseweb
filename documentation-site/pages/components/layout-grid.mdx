...
<API heading="Grid" api={require('!!extract-react-types-loader!../../../src/layout-grid/grid')} />

<API heading="Cell" api={require('!!extract-react-types-loader!../../../src/layout-grid/cell')} />
