...
import Cells from 'examples/table-semantic/cells.js';
...
import Alternating from 'examples/table-semantic/alternating.js';
...
<Example title="Common cell examples" path="table-semantic/cells.js">
  <Cells />
</Example>
...
<Example title="Table Builder with alternating rows" path="table-semantic/alternating.js">
  <Alternating />
</Example>
...
<Example title="Table with empty message" path="table-semantic/empty-message.js">
  <EmptyMessage />
</Example>
...
<ApiTable
  ...
  types={require('!!extract-react-types-loader!../../../src/table-semantic/table')}
/>
