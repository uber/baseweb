...
<Example title="Rating with stars" path="examples/rating/star.js">
  <Star />
</Example>

<Example title="Rating with emoticons" path="examples/rating/emoticon.js">
  <Emoticon />
</Example>
...
<Overrides
  ...
  whitelisted={['Root', 'Item']}
  renderExample={props => (
    <React.Fragment>
      <EmoticonRating value={2} overrides={props.overrides} />
      <Block marginTop="scale600">
        <StarRating value={3} overrides={props.overrides} />
      </Block>
    </React.Fragment>
  )}
/>
