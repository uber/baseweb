...
<Example title="Overriding sub-components" path="checkbox/component-overrides.tsx">
  <ComponentOverrides />
</Example>
...
<Example title="Stateful (uncontrolled) usage" path="checkbox/basic-uncontrolled.tsx">
  <Uncontrolled />
</Example>
