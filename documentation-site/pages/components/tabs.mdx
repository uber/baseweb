...
Both vertical and horizontal orientations support overflow scrolling. The active tab will be scrolled into view on mount and when the active tab changes.
