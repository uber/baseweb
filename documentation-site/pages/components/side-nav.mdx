...
import SideNavBasic from 'examples/side-navigation/basic.tsx';
import NavOverrides from 'examples/side-navigation/nav-overrides.tsx';
...
<Yard placeholderHeight={192} {...sideNavYardConfig} />
...
<Example title="Side navigation basic usage" path="side-navigation/basic.tsx">
  <SideNavBasic />
</Example>

<Example title="Side navigation with overrides" path="side-navigation/nav-overrides.tsx">
  <NavOverrides />
</Example>
...
<Exports component={NavExports} title="Side Navigation exports" path="baseui/side-navigation" />
