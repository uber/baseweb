...
<Example title="With icons" path="button-group/icon.tsx">
  <Icon />
</Example>

<Example title="With enhancers" path="button-group/enhancer.tsx">
  <Enhancer />
</Example>

<Example title="Radio mode" path="button-group/radio-mode.tsx">
  <RadioMode />
</Example>

In `radio` mode, the button group functions similarly to a radio group. Only one button can be "selected" at a time.

<Example title="Checkbox mode" path="button-group/checkbox-mode.tsx">
  <CheckboxMode />
</Example>
...
<Example title="Disabled button group" path="button-group/disabled.tsx">
  <Disabled />
</Example>
...
<Example title="Single disabled button" path="button-group/disabled-button.tsx">
  <DisabledButton />
</Example>
...
<Example title="Stateful (uncontrolled) with radio mode" path="button-group/stateful-radio.tsx">
  <StatefulRadio />
</Example>
...
<Example
  ...
  path="button-group/stateful-checkbox.tsx"
>
  <StatefulCheckbox />
</Example>
