...
<Example title="Small marker with no anchor" path="floating-marker/small-no-anchor.tsx">
  <FloatingMarkerContainer>
    <SmallNoAnchor />
  </FloatingMarkerContainer>
</Example>
...
<Example title="Two labels with custom color" path="floating-marker/secondary-label-color.tsx">
  <FloatingMarkerContainer>
    <SecondaryLabelColor />
  </FloatingMarkerContainer>
</Example>
...
<Example title="Usage with react-map-gl" path="floating-marker/react-map-gl.tsx">
  <ReactMapGL />
</Example>
