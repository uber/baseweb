...
A large floating marker with a square anchor and start enhancer. Because the floating marker is size large, make sure to update the enhancer icon size: `<Search size="24px" />`.
