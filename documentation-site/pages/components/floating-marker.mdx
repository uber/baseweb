...
import Basic from "examples/floating-marker/basic.tsx";
import LargeTopRight from "examples/floating-marker/large-top-right.tsx";
import StartEnhancer from "examples/floating-marker/start-enhancer.tsx";
import SmallNoAnchor from "examples/floating-marker/small-no-anchor.tsx";
import LargeSquareAnchorStartEnhancer from "examples/floating-marker/large-square-anchor-start-enhancer.tsx";
import SecondaryLabel from "examples/floating-marker/secondary-label.tsx";
import SecondaryLabelColor from "examples/floating-marker/secondary-label-color.tsx";
import ReactMapGL from "examples/floating-marker/react-map-gl.tsx";
import { FloatingMarkerSizingTable } from "../../components/map-marker-sizing-table.jsx";
...
<Example title="Basic usage with label" path="floating-marker/basic.tsx">
...
<Example
  ...
  path="floating-marker/large-top-right.tsx"
>
  <FloatingMarkerContainer>
    <LargeTopRight />
  </FloatingMarkerContainer>
...
<Example title="Start enhancer" path="floating-marker/start-enhancer.tsx">
  <FloatingMarkerContainer>
    <StartEnhancer />
  </FloatingMarkerContainer>
</Example>
...
<Example
  ...
  path="floating-marker/small-no-anchor.tsx"
>
  <FloatingMarkerContainer>
    <SmallNoAnchor />
  </FloatingMarkerContainer>
...
<Example
  ...
  path="floating-marker/large-square-anchor-start-enhancer.tsx"
>
  <FloatingMarkerContainer>
...
<Example title="Two labels" path="floating-marker/secondary-label.tsx">
  <FloatingMarkerContainer>
    <SecondaryLabel />
  </FloatingMarkerContainer>
</Example>
...
<Example
  title="Two labels with custom color"
  path="floating-marker/secondary-label-color.tsx"
>
  <FloatingMarkerContainer>
    <SecondaryLabelColor />
  </FloatingMarkerContainer>
...
<Example
  ...
  path="floating-marker/react-map-gl.tsx"
>
  <ReactMapGL />
</Example>
