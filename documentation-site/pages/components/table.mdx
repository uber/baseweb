...
<Example title="Table with fixed width column" path="table/fixed-width-column.tsx">
  <FixedWidthColumn />
</Example>
...
<Example title="Table with horizontal scroll" path="table/horizontal-scroll.tsx">
  <HorizontalScroll />
</Example>
