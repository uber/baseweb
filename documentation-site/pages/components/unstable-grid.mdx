...
import BasicExample from 'examples/grid/basic.js';
import SpanExample from 'examples/grid/span.js';
import ResponsiveExample from 'examples/grid/responsive.js';
import HideExample from 'examples/grid/hide.js';
import SkipExample from 'examples/grid/skip.js';
import SkipShrinkExample from 'examples/grid/skip-shrink.js';
import AlignExample from 'examples/grid/align.js';
import OrderExample from 'examples/grid/order.js';
import BehaviorExample from 'examples/grid/behavior.js';
import CustomExample from 'examples/grid/custom.js';
...
You may need to open some examples in CodeSandbox to achieve a wide enough viewport for certain behaviors.

<Example title="Basic" path="grid/basic.js">
  <BasicExample />
</Example>
...
<Example title="Span" path="grid/span.js">
  <SpanExample />
</Example>
...
By default the gap between wrapped cell rows is 0. You can specify a gap with the responsive `gridGaps` prop. Remember that you can also add a new `Grid` to your page if you want to closely control vertical spacing.
...
<Example title="Responsive" path="grid/responsive.js">
  <ResponsiveExample />
</Example>
...
<Example title="Hide" path="grid/hide.js">
  <HideExample />
</Example>
...
<Example title="Skip" path="grid/skip.js">
  <SkipExample />
</Example>
...
<Example title="Order" path="grid/order.js">
  <OrderExample />
</Example>
...
<Example title="Behavior" path="grid/behavior.js">
  <BehaviorExample />
</Example>
...
<Example title="Custom" path="grid/custom.js">
  <CustomExample />
</Example>
...
<API
  ...
  api={require('!!extract-react-types-loader!../../../src/grid/styled-components.js')}
/>
