...
<Example title="Avatar with available sizes" 
         path="examples/avatar/sizes.js" 
         isEditable={true} 
         code={code} 
         scope={{Avatar}} />
...
<Example title="Avatar with initals" path="examples/avatar/initals.js">
  <Initals />
</Example>
