...
<Example title="Pagination Uncontrolled example" path="pagination/uncontrolled.tsx">
  <Uncontrolled />
</Example>
...
<Exports component={PaginationExports} title="Pagination exports" path="baseui/pagination" />
