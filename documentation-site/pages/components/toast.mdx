...
<Example title="Toast Notification Basic Usage" path="toast/toast-notification.tsx">
  <ToastNotification />
</Example>

<Example
  title="Toaster Using Key To Update Open Toasts"
  path="toast/toast-same-key-notification.tsx"
>
  <ToastSameKeyNotification />
</Example>

<Example title="Toast Being Closed From Outside" path="toast/toast-close-from-outside.tsx">
