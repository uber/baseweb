...
<API
  ...
  api={require('!!extract-react-types-loader!../../../src/heading/heading-level')}
/>

<API
  heading="Heading API"
  api={require('!!extract-react-types-loader!../../../src/heading/heading')}
/>

<Exports component={HeadingExports} title="Heading exports" path="baseui/heading" />
