...
<Example title="Heading basic usage" path="examples/heading/basic.js">
  <Basic />
</Example>
...
<Example
  ...
  path="examples/heading/decouple-styles.js"
>
  <DecoupleStyles />
</Example>
...
<API
  ...
  api={require('!!@uber-web-ui/extract-react-types-loader!../../../src/heading/heading-level.js')}
/>

<API
  heading="Heading API"
  api={require('!!@uber-web-ui/extract-react-types-loader!../../../src/heading/heading.js')}
/>
