...
<Example title="Basic usage with label" path="floating-route-marker/basic.js">
...
<Example title="Primary and secondary labels" path="floating-route-marker/secondary-label.js">
  <FloatingMarkerContainer>
    <SecondaryLabel />
  </FloatingMarkerContainer>
</Example>
...
<Example title="Start and end enhancers" path="floating-route-marker/start-end-enhancer.js">
  <FloatingMarkerContainer>
    <StartEndEnhacer />
  </FloatingMarkerContainer>
</Example>
