...
<Example title="Button kinds" path="examples/button/basic.js">
  <BasicButton />
</Example>
...
<Example title="Button with enhancers" path="examples/button/with-enhancers.js">
  <WithEnhancer />
</Example>
...
<Example title="Button dropdown" path="examples/button/dropdown.js">
  <Dropdown />
</Example>

<Example title="Button as an Anchor" path="examples/button/as-an-anchor.js">
  <ButtonAsAnAnchor />
</Example>
...
<Overrides
  ...
  renderExample={props => (
    <React.Fragment>
      ...
      <Button loading kind={KIND.secondary} overrides={props.overrides}>
        Loading
      </Button>
    </React.Fragment>
  )}
...
<API
  heading="Button API"
  api={require('!!extract-react-types-loader!../../../src/button/button.js')}
/>
