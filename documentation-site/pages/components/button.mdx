...
<Example title="Button kinds" path="button/basic.js">
  <BasicButton />
</Example>

<Example title="Button states" path="button/states.js">
  <States />
</Example>

<Example title="Button sizes" path="button/basic-compact.js">
  <BasicButtonCompact />
</Example>

<Example title="Button with enhancers" path="button/with-enhancers.js">
  <WithEnhancer />
</Example>

<Example title="Button shapes" path="button/shapes.js">
  <Shapes />
</Example>

<Example title="Button dropdown" path="button/dropdown.js">
  <Dropdown />
</Example>

<Example title="Button as an Anchor" path="button/as-an-anchor.js">
  <ButtonAsAnAnchor />
</Example>
