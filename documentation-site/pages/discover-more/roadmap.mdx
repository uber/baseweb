...
We have a new major version, **v11**, planned for **September of 2021**. Below you will find all of the potentially breaking changes we are including in v11. To provide a seamless upgrade experience, we'll ship codemods for all changes.
