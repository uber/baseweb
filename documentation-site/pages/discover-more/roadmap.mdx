...
We have a new major version, **v11**, planned for **March of 2022**. Below you will find all of the potentially breaking changes we are including in v11. To provide a seamless upgrade experience, we'll ship codemods for all changes.
