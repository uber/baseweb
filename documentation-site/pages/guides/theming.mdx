...
export const styledThemed = createStyledThemed<CustomThemeT>();
export const withStyleThemed = createWithStyleThemed<CustomThemeT>();
export const useStyletronThemed = createUseStyletronThemed<CustomThemeT>();
```

You can import these custom themed utilities wherever you want access to your custom theme.

```js
import {useStyletronThemed as useStyletron} from 'path/to/my-style-utils.js';
