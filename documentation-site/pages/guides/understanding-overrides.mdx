...
>
  By the end of this guide, you'll learn the concept of overrides in Base Web and the ways you can
  use them to change the look or the behavior of components.
</Notification>
