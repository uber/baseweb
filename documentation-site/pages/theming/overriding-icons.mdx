...
With Base Web, you can use your custom iconset. To do that, you have yo provide your icons in the theme.
...
You can find more about the [Icon API here](/components/icon/#icon-api).
