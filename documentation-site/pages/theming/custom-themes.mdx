...
With the `ThemeProvider`, you can apply a theme to your application locally. By default, Base Web ships with a light and a dark theme. For global theming, please
refer to the [BaseProvider](/components/base-provider/).
...
default theme shape (see below). However, if you create a custom theme with additional fields,
