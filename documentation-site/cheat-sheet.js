const outlines = [
  ...
  },
  {
    ...
    definitions: [
      ...
      { name: 'StateReducer', lineStart: 113, children: [] },
      { name: 'StatefulContainerChildProps', lineStart: 120, children: [] },
      {
        name: 'DefaultStatefulProps',
        lineStart: 136,
        children: [
          { name: 'initialState', lineStart: 137 },
          { name: 'children', lineStart: 138 },
          { name: 'stateReducer', lineStart: 139 },
          { name: 'onChange', lineStart: 140 },
          { name: 'onMouseEnter', lineStart: 141 },
          { name: 'onMouseLeave', lineStart: 142 },
          { name: 'onFocus', lineStart: 143 },
          { name: 'onBlur', lineStart: 144 },
        ],
      },
      {
        ...
        children: [
          ...
          { name: 'children', lineStart: 150 },
          { name: 'initialState', lineStart: 152 },
          { name: 'stateReducer', lineStart: 154 },
          { name: 'onChange', lineStart: 156 },
          { name: 'onMouseEnter', lineStart: 158 },
          { name: 'onMouseLeave', lineStart: 160 },
          { name: 'onFocus', lineStart: 162 },
          { name: 'onBlur', lineStart: 164 },
          { name: 'autoFocus', lineStart: 166 },
        ],
      },
      { name: 'StatefulCheckboxProps', lineStart: 169, children: [] },
      {
        name: 'SharedStyleProps',
        lineStart: 175,
        children: [
          ...
          { name: '$error', lineStart: 180 },
          { name: '$checked', lineStart: 181 },
          { name: '$isIndeterminate', lineStart: 182 },
          { name: '$required', lineStart: 183 },
          { name: '$disabled', lineStart: 184 },
          { name: '$value', lineStart: 185 },
          { name: '$labelPlacement', lineStart: 186 },
        ],
      },
    ],
  },
    ...
    definitions: [
      ...
      { name: 'LocationPuckType', lineStart: 45, children: [] },
      {
        ...
        children: [
          ...
          { name: 'LabelSlot', lineStart: 51 },
          { name: 'Label', lineStart: 52 },
          { name: 'SecondaryLabel', lineStart: 53 },
          { name: 'EnhancerSlot', lineStart: 54 },
          { name: 'PinHeadContainer', lineStart: 55 },
          { name: 'AnchorContainer', lineStart: 56 },
          { name: 'Needle', lineStart: 57 },
          { name: 'DragShadow', lineStart: 58 },
          { name: 'DragShadowContainer', lineStart: 59 },
          { name: 'DragContainer', lineStart: 60 },
          { name: 'BadgeEnhancer', lineStart: 61 },
          { name: 'LabelEnhancer', lineStart: 62 },
          { name: 'LabelEnhancerContainer', lineStart: 63 },
        ],
      },
      {
        name: 'NeedleProps',
      ...
      },
      {
        ...
        lineStart: 78,
        children: [
          { name: 'labelEnhancerContent', lineStart: 79 },
          { name: 'labelEnhancerPosition', lineStart: 80 },
        ],
      },
      { name: 'LabelEhancerComponent', lineStart: 83, children: [] },
      {
        name: 'BadgeEnhancer',
        lineStart: 89,
        children: [
          { name: 'badgeEnhancerSize', lineStart: 90 },
          { name: 'badgeEnhancerContent', lineStart: 91 },
        ],
      },
      { name: 'BadgeEnhancerComponent', lineStart: 96, children: [] },
      {
        name: 'BadgePosition',
        lineStart: 101,
        children: [
          { name: 'x', lineStart: 102 },
          { name: 'y', lineStart: 103 },
        ],
      },
      { name: 'FixedMarkerProps', lineStart: 106, children: [] },
      {
        name: 'FloatingMarkerOverrides',
        lineStart: 122,
        children: [
          { name: 'Root', lineStart: 123 },
          { name: 'InnerAnchor', lineStart: 124 },
          { name: 'OuterAnchor', lineStart: 125 },
          { name: 'PinHead', lineStart: 126 },
          { name: 'LabelSlot', lineStart: 127 },
          { name: 'Label', lineStart: 128 },
          { name: 'SecondaryLabel', lineStart: 129 },
          { name: 'EnhancerSlot', lineStart: 130 },
          { name: 'PinHeadContainer', lineStart: 131 },
          { name: 'AnchorContainer', lineStart: 132 },
          { name: 'Needle', lineStart: 133 },
          { name: 'DragShadow', lineStart: 134 },
          { name: 'DragShadowContainer', lineStart: 135 },
          { name: 'DragContainer', lineStart: 136 },
          { name: 'BadgeEnhancer', lineStart: 137 },
          { name: 'LabelEnhancer', lineStart: 138 },
          { name: 'LabelEnhancerContainer', lineStart: 139 },
        ],
      },
      {
        ...
        lineStart: 142,
        children: [
          { name: 'label', lineStart: 143 },
          { name: 'secondaryLabel', lineStart: 144 },
          { name: 'anchor', lineStart: 145 },
          { name: 'endEnhancer', lineStart: 146 },
          { name: 'startEnhancer', lineStart: 149 },
          { name: 'anchorType', lineStart: 152 },
          { name: 'size', lineStart: 153 },
          { name: 'overrides', lineStart: 154 },
        ],
      },
      { name: 'PinHeadProps', lineStart: 157, children: [] },
      {
        name: 'DragShadowProps',
        lineStart: 176,
        children: [
          { name: 'background', lineStart: 177 },
          { name: 'dragging', lineStart: 178 },
          { name: 'height', lineStart: 179 },
          { name: 'overrides', lineStart: 180 },
        ],
      },
      {
        ...
        lineStart: 183,
        children: [
          { name: 'Root', lineStart: 184 },
          { name: 'LocationPuckApproximation', lineStart: 185 },
          { name: 'ConsumerLocationPuckCore', lineStart: 186 },
          { name: 'EarnerLocationPuckCore', lineStart: 187 },
        ],
      },
      {
      ...
      },
      {
        ...
        lineStart: 199,
        children: [
          { name: 'heading', lineStart: 200 },
          { name: 'confidenceRadius', lineStart: 201 },
          { name: 'showHeading', lineStart: 202 },
          { name: 'overrides', lineStart: 203 },
        ],
      },
      {
        ...
        lineStart: 205,
        children: [
          { name: 'heading', lineStart: 206 },
          { name: 'confidenceRadius', lineStart: 207 },
          { name: 'size', lineStart: 208 },
          { name: 'overrides', lineStart: 209 },
        ],
      },
    ],
  },
