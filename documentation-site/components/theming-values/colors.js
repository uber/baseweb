...
function Colors() {
  const primaryColors = {
    ...
    primary300: {color: LightTheme.colors.primary300, dark: false},
  ...
  const monoColors = {
    mono50: {color: LightTheme.colors.mono50, dark: true},
    ...
    mono500: {color: LightTheme.colors.mono500, dark: false},
    mono600: {color: LightTheme.colors.mono600, dark: false},
    mono700: {color: LightTheme.colors.mono700, dark: false},
  ...
  const bwColors = {
    black: {color: LightTheme.colors.black, dark: false},
    white: {color: LightTheme.colors.white, dark: true},
  };
