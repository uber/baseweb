...
export default function SvgSpinner(props) {
  ...
  return (
    <svg width={232} height={145} fill="none" {...props}>
      <circle cx={116} cy={73} r={15.5} stroke={colors[0]} strokeWidth={3} />
      ...
      <path
        d="M116 57.497c0-.827.671-1.504 1.495-1.431a17.002 17.002 0 0115.503 16.67 16.991 16.991 0 01-1.44 7.115c-.333.757-1.25 1.019-1.974.62v0c-.724-.398-.981-1.306-.662-2.068a14.003 14.003 0 00-11.428-19.33c-.822-.087-1.494-.75-1.494-1.576v0z"
        stroke={colors[2]}
        strokeWidth={6}
